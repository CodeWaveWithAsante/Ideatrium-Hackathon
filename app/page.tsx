...
function HomePage() {
  ...
  const handleUpdateIdea = async (
    id: string,
    updates: Partial<Omit<import("@/lib/types").Idea, "id" | "createdAt">>
  ) => {
    try {
  ...
  const handleToggleArchived = () => {
    ...
    toast.info(
      showArchived ? "Viewing active ideas" : "Viewing archived ideas",
      {
        description: showArchived
          ? "Switched to your active idea collection."
          : "Switched to your archived ideas.",
      }
    );
  };
  ...
  const handleToggleView = () => {
    if (activeTab === "ideas" && !showArchived) {
      ...
      toast.info(`Switched to ${newMode} view`, {
        description:
          newMode === "matrix"
            ? "Ideas organized by Eisenhower Matrix."
            : "Ideas displayed in grid layout.",
      });
    }
  };
          ...
          <div className="flex items-center justify-center gap-3 mb-6 animate-in slide-in-from-top duration-700">
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-r from-blue-600 to-purple-600 p-6 rounded-3xl group-hover:scale-105 transition-transform duration-300">
                <Lightbulb className="h-5 md:h-12 w-5 md:w-12 text-white" />
              </div>
            </div>
            <div>
            ...
            {user && (
              <div className="flex items-center gap-2 animate-in slide-in-from-right duration-700 delay-300">
        ...
        >
          <div className="flex justify-center animate-in slide-in-from-bottom duration-700 delay-400">
            <TabsList className="grid w-full max-w-2xl grid-cols-4 bg-white bg-opacity-50 dark:bg-slate-800 dark:bg-opacity-50 backdrop-blur-sm border border-white border-opacity-20 dark:border-slate-700 dark:border-opacity-50">
              <TabsTrigger
                value="ideas"
                className="gap-2 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-700 hover:bg-white hover:bg-opacity-70 dark:hover:bg-slate-700 dark:hover:bg-opacity-70 transition-all duration-200"
              >
                <Image src="/logo.svg" alt="Ideas" width={16} height={16} />
                Ideas
              </TabsTrigger>
              <TabsTrigger
                value="insights"
          ...
          >
            <div className="text-center mb-8 animate-in slide-in-from-top duration-700">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Discover patterns and get intelligent recommendations for your
                ideas using advanced AI analysis
              </p>
            </div>
          ...
          >
            <div className="text-center mb-8 animate-in slide-in-from-top duration-700">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Discover random inspiration from your idea collection and break
          ...
          >
            <div className="text-center mb-8 animate-in slide-in-from-top duration-700">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Track your creativity patterns and productivity metrics with
                detailed insights
              </p>
            </div>
            <div className="animate-in slide-in-from-bottom duration-700 delay-200">
