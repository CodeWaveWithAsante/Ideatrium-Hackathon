...
export function AuthGuard({ children, fallback }: AuthGuardProps) {
  ...
  if (loading) {
    return (
      <SpinnerLoader title="Loading..." message="Preparing your workspace" />
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-4">
        ...
        <div className="w-full max-w-6xl py-16 2xl:py-20">
          ...
          <div className="text-center mb-16 animate-in fade-in duration-1000">
            <div className="flex md:items-center justify-center gap-4 mb-8 animate-in slide-in-from-top duration-700">
            ...
            <div className="max-w-3xl mx-auto space-y-6 animate-in slide-in-from-bottom duration-700 delay-200">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed text-left md:text-center">
                Capture brilliant ideas, prioritize with the Eisenhower Matrix,
                and transform concepts into actionable tasks. Powered by AI
                insights and designed for creative minds.
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                title: "Cloud Sync",
                description:
                  "Access your ideas from any device with automatic synchronization and real-time updates",
              ...
              },
              {
                ...
                description:
                  "Your ideas are safely stored and backed up in the cloud with enterprise-grade security",
              ...
              },
              {
                ...
                title: "AI Insights",
                description:
                  "Get intelligent suggestions and automated analysis powered by advanced AI technology",
              ...
              },
              {
                ...
                description:
                  "Organize ideas using the Eisenhower Matrix and convert top priorities into actionable tasks",
              ...
              },
              {
                ...
                description:
                  "Changes sync instantly across all your devices with conflict resolution and version history",
              ...
              },
              {
                ...
                description:
                  "Advanced filtering, bulk operations, keyboard shortcuts, and idea roulette for inspiration",
              ...
              <div
                key={index}
                className={`group relative animate-in slide-in-from-bottom duration-700 ${feature.delay}`}
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${feature.gradient} rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-300`}
                ></div>
                <Card className="relative bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border-white/20 dark:border-slate-700/50 hover:bg-white/80 dark:hover:bg-slate-800/80 transition-all duration-300 group-hover:scale-105">
                  <CardHeader className="text-center pb-4">
                    <div
                      className={`mx-auto mb-4 p-3 ${feature.iconBg} rounded-xl w-fit group-hover:scale-110 transition-transform duration-300`}
                    >
                      <feature.icon
              ...
              <CardContent className="relative p-6 md:p-12 text-center">
                <div className="max-w-2xl mx-auto space-y-6">
                  ...
                  <p className="text-lg text-muted-foreground">
                    Join thousands of creative minds who use Ideatrium to
                    capture, organize, and execute their best ideas.
                  </p>

                  <Button
                    onClick={() => setShowAuthModal(true)}
                    size="lg"
                    className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white md:px-8 py-6 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                  >
                    Start Your Creative Journey
                  </Button>

                  <p className="text-sm text-muted-foreground">
                    Free to start • No credit card required • Sync across all
                    devices
                  </p>
                </div>
              </CardContent>
