...
export function TaskConverter({ idea, onConvert }: TaskConverterProps) {
  ...
  const [formData, setFormData] = useState<TaskFormData>({
    ...
    priority: idea.quadrant === 'q2' ? 'high' : idea.quadrant === 'q1' ? 'medium' : 'low',
    dueDate: undefined,
      ...
      <DialogContent className="sm:max-w-[600px] xl:max-w-[800px] max-h-[95vh] flex flex-col p-0">
        <div className="px-6 pt-6 pb-4 border-b">
          <DialogHeader>
            ...
            <DialogDescription>
              Transform your idea into an actionable task with deadlines and subtasks.
            </DialogDescription>
          </DialogHeader>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger>
                    <div className="flex items-center gap-2">
                      <PriorityIcon className="h-4 w-4" style={{ color: selectedPriority?.color }} />
                      <SelectValue />
                    </div>
                  </SelectTrigger>
                  <SelectContent>
