...
export function InsightsDashboard({ ideas }: InsightsDashboardProps) {
  ...
  const getInsightColor = (type: string) => {
    switch (type) {
      ...
      case 'opportunity': return 'bg-orange-50 border-orange-200 text-orange-800';
    ...
    <Card className="border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-blue-50">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-xs text-muted-foreground text-center pt-4 border-t">
          ...
          AI insights help you understand patterns and optimize your idea development process
        </div>
      </CardContent>
    </Card>
  );
